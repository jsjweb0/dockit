...
export function DefaultFooter() {
  return (
    <footer className="border-t border-border px-4 md:px-6">
      <div className="mx-auto flex justify-between items-end max-w-7xl py-4 md:py-5">
        <div>
        ...
        <div className="flex gap-2.5 mt-2">
          <a
            ...
            aria-label="이메일 보내기"
            className="inline-flex items-center justify-center size-8 rounded-full bg-primary/5 transition-colors hover:bg-primary/12"
          >
